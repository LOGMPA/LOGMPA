...
export default function Concluidos() {
  ...
  const transports = allTransports.filter(t => 
      ...
      <div className="max-w-[1800px] mx-auto">
        <div className="mb-6 bg-gradient-to-r from-green-600 via-lime-500 to-yellow-400 rounded-xl p-4 shadow-lg">
          <div className="flex items-center justify-between gap-3">
            <h1 className="text-xl font-bold text-white whitespace-nowrap">Concluídos</h1>
        ...
        <div className="mb-4">
          <p className="text-sm text-gray-600">
            Exibindo <span className="font-semibold">{filteredTransports.length}</span> de <span className="font-semibold">{transports.length}</span> transportes concluídos
          </p>
        </div>
